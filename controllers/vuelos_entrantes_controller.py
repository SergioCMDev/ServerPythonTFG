...
def obtener_cantidad_ciudad(Pais, Ciudad, AnioInicio, AnioFin):
    ...
    Obtener cantidad de vuelos entrantes totales en las ciduad de un pais durante un rango de años
    :param Pais: Pais
    :type Pais: str
    :param Ciudad: Ciudad
    :type Ciudad: str
...
def obtener_cantidad_mensualmente(Pais, Anio_Fin, AnioFin):
    """
